"""
Run ONCE before building:  python make_icon_stable.py
Generates icon.ico (RED theme) for Stable version.
"""
import os, sys
...
def make():
    ...
    print(f"[OK] icon.ico (RED) created at: {out}")
